...
*/
#define USE_CAN_43_FLEXCAN_MODULE      ([!VAR "MDL_DEF" = "0"!][!LOOP "as:modconf("Can")/../.."!][!IF "text:match(node:name(.), "^Can_43_FLEXCAN$")"!][!VAR "MDL_DEF" = "1"!][!ENDIF!][!ENDLOOP!][!IF "$MDL_DEF = 1"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])

/** 
* @brief This constant used for other modules to check if CAN_43_CANEXCEL is present in the project.   
*/
#define USE_CAN_43_CANEXCEL_MODULE      ([!VAR "MDL_DEF" = "0"!][!LOOP "as:modconf("Can")/../.."!][!IF "text:match(node:name(.), "^Can_43_CANEXCEL$")"!][!VAR "MDL_DEF" = "1"!][!ENDIF!][!ENDLOOP!][!IF "$MDL_DEF = 1"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
*/
#define USE_LIN_43_LPUART_FLEXIO_MODULE      ([!VAR "MDL_DEF" = "0"!][!LOOP "as:modconf("Lin")/../.."!][!IF "text:match(node:name(.), "^Lin_43_LPUART_FLEXIO$")"!][!VAR "MDL_DEF" = "1"!][!ENDIF!][!ENDLOOP!][!IF "$MDL_DEF = 1"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])

/**
* @brief This constant used for other modules to check if Lin_43_LINFLEXD is present in the project.   
*/
#define USE_LIN_43_LINFLEXD_MODULE      ([!VAR "MDL_DEF" = "0"!][!LOOP "as:modconf("Lin")/../.."!][!IF "text:match(node:name(.), "^Lin_43_LINFLEXD$")"!][!VAR "MDL_DEF" = "1"!][!ENDIF!][!ENDLOOP!][!IF "$MDL_DEF = 1"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
[!LOOP "as:modconf("Wdg")/../.."!][!//
[!IF "text:match(node:name(.), '^Wdg$')"!][!VAR "MDL_DEF" = "1"!] [!VAR "isAnyWdgInstanceUsed" = "1"!][!ENDIF!][!//
[!ENDLOOP!][!//
...
[!LOOP "as:modconf("Wdg")/../.."!][!//
[!IF "text:match(node:name(.), concat('^Wdg_43_Instance',string($i),'$'))"!][!VAR "MDL_DEF" = "1"!] [!VAR "isAnyWdgInstanceUsed" = "1"!] [!ENDIF!][!//
[!ENDLOOP!][!//
[!IF "$MDL_DEF = 1"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
[!ENDFOR!][!//

...
#define EMIOS_OCU_IP[!"$VS_number"!]_PBCFG_AR_RELEASE_MINOR_VERSION        7
#define EMIOS_OCU_IP[!"$VS_number"!]_PBCFG_AR_RELEASE_REVISION_VERSION     0
#define EMIOS_OCU_IP[!"$VS_number"!]_PBCFG_SW_MAJOR_VERSION                3
#define EMIOS_OCU_IP[!"$VS_number"!]_PBCFG_SW_MINOR_VERSION                0
#define EMIOS_OCU_IP[!"$VS_number"!]_PBCFG_SW_PATCH_VERSION                0
/*==================================================================================================
*                                      FILE VERSION CHECKS
==================================================================================================*/
...
[!VAR "AlreadyParsedModules"!][!ENDVAR!][!//
    [!LOOP "OcuConfigSet/OcuHWSpecificSettings/*"!][!//
        ...
        [!IF "contains($AlreadyParsedModules, $InstanceNum) = false()"!][!//
            ...
            [!CODE!][!WS "0"!]extern const Emios_Ocu_Ip_ConfigType Emios_Ocu_Ip_[!"$InstanceNum"!]_ModuleCfgPB[!"$VS_number"!];[!CR!][!ENDCODE!][!//
        [!ENDIF!][!//
    [!ENDLOOP!][!//
[!ENDNOCODE!]

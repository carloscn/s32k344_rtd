1. Example Description
    ...
    1.1 The application software functionality
        Pins configuration using Port driver and led toggle using Dio driver
2. Installation steps
    2.1 Hardware installation
        2.1.1 Supported boards
            ...
            - S32K3X4EVB-Q172
        2.1.2 Connections
            - PTA29, PTB18 is controlling the LED_RED in S32K3X4EVB-Q172 EVB board - when HIGH LED is ON when LOW LED is OFF.
            - PTA29, PTB18 is controlling the LED_RED in S32K3X4EVB-Q257 EVB board - when HIGH LED is ON when LOW LED is OFF.
        2.1.3 Debugger
    ...
    2.2 Software installation
        ...
        2.2.2 Example configuration
            ...
            - TRESOS_DIR the installation path of Elektrobit Tresos (used for generating the project from command line)
                Ex: TRESOS_DIR = C:/EB29.0.0/tresos

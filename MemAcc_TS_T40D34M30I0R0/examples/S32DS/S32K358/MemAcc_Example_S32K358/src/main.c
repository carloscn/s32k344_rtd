...
==================================================================================================*/
#define TEST_AREA       (0U)
#define ERASE_ADDR      (0x0U)
#define WRITE_ADDR      (0x1000U)
#define SECTOR_SIZE     (0x2000U)
#define WRITE_SIZE      (32U)
/*==================================================================================================
*                                      LOCAL CONSTANTS
==================================================================================================*/
...
int main(void)
{
    ...
    /* Erase */
    ExampleAssert(E_OK == MemAcc_Erase(TEST_AREA, ERASE_ADDR, SECTOR_SIZE));
    ExampleProcessJobs();

    /* BlankCheck */
    ExampleAssert(E_OK == MemAcc_BlankCheck(TEST_AREA, ERASE_ADDR, SECTOR_SIZE));
    ExampleProcessJobs();

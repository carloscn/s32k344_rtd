...
[!LOOP "variant:all()"!]
[!CODE!]#include "Eth_43_GMAC_Ipw_[!"."!]_PBcfg.h"[!CR!][!ENDCODE!]
[!ENDLOOP!]
[!ELSE!]
[!CODE!]#include "Eth_43_GMAC_Ipw_PBcfg.h"[!ENDCODE!]
[!ENDIF!]
[!ENDNOCODE!]
...
[!LOOP "variant:all()"!]
[!CODE!][!//
/* Checks against Eth_43_GMAC_Ipw_[!"."!]_PBcfg.h */
#if (ETH_43_GMAC_IPW_CFG_VENDOR_ID != ETH_43_GMAC_IPW_PBCFG_[!"."!]_VENDOR_ID)
    #error "Eth_43_GMAC_Ipw_Cfg.h and Eth_43_GMAC_Ipw_[!"."!]_PBcfg.h have different vendor ids"
#endif
#if ((ETH_43_GMAC_IPW_CFG_AR_RELEASE_MAJOR_VERSION    != ETH_43_GMAC_IPW_PBCFG_[!"."!]_AR_RELEASE_MAJOR_VERSION) || \
     (ETH_43_GMAC_IPW_CFG_AR_RELEASE_MINOR_VERSION    != ETH_43_GMAC_IPW_PBCFG_[!"."!]_AR_RELEASE_MINOR_VERSION) || \
     (ETH_43_GMAC_IPW_CFG_AR_RELEASE_REVISION_VERSION != ETH_43_GMAC_IPW_PBCFG_[!"."!]_AR_RELEASE_REVISION_VERSION))
     #error "AUTOSAR Version Numbers of Eth_43_GMAC_Ipw_Cfg.h and Eth_43_GMAC_Ipw_[!"."!]_PBcfg.h are different"
#endif
#if ((ETH_43_GMAC_IPW_CFG_SW_MAJOR_VERSION != ETH_43_GMAC_IPW_PBCFG_[!"."!]_SW_MAJOR_VERSION) || \
     (ETH_43_GMAC_IPW_CFG_SW_MINOR_VERSION != ETH_43_GMAC_IPW_PBCFG_[!"."!]_SW_MINOR_VERSION) || \
     (ETH_43_GMAC_IPW_CFG_SW_PATCH_VERSION != ETH_43_GMAC_IPW_PBCFG_[!"."!]_SW_PATCH_VERSION))
    #error "Software Version Numbers of Eth_43_GMAC_Ipw_Cfg.h and Eth_43_GMAC_Ipw_[!"."!]_PBcfg.h are different"
#endif
[!ENDCODE!]
[!ENDLOOP!]
[!ELSE!]
...
==================================================================================================*/
[!NOCODE!]
[!CODE!]#define ETH_43_GMAC_IPW_CONFIG_EXT \[!CR!][!ENDCODE!]
[!IF "var:defined('postBuildVariant')"!]
[!LOOP "variant:all()"!][!//
    [!CODE!][!WS "4"!]ETH_43_GMAC_IPW_CONFIG_[!"."!]_PB \[!CR!][!ENDCODE!]
[!ENDLOOP!][!//
[!ELSE!][!//
    [!CODE!][!WS "4"!]ETH_43_GMAC_IPW_CONFIG_PB[!ENDCODE!]
[!ENDIF!]
[!ENDNOCODE!]

...
[!IF "node:exists(as:modconf("Resource")[1]/ResourceGeneral/ResourceSubderivative)"!][!//
    ...
    [!IF "contains($DerivativeName, 'S32K3')"!][!//
        [!IF "contains($DerivativeName, 'S32K396') or contains($DerivativeName, 'S32K394')"!][!//
            [!CODE!][!WS "0"!]#include "S32K39_EDMA.h"[!CR!][!ENDCODE!][!//
            [!CODE!][!WS "0"!]
            #include "S32K39_DMA_TCD_0.h"
            #include "S32K39_DMA_TCD_1.h"
            [!CR!][!ENDCODE!][!//
        [!ELSEIF "contains($DerivativeName, 'S32K358') or contains($DerivativeName, 'S32K388') or contains($DerivativeName, 'S32K311')"!][!//
            [!CODE!][!WS "0"!]#include "[!"$DerivativeName"!]_EDMA.h"[!CR!][!ENDCODE!][!//
            [!CODE!][!WS "0"!]
            #include "[!"$DerivativeName"!]_DMA_TCD.h"
            [!CR!][!ENDCODE!][!//
        [!ELSEIF "contains($DerivativeName, 'S32K310')"!][!//
            [!CODE!][!WS "0"!]#include "S32K311_EDMA.h"[!CR!][!ENDCODE!][!//
            [!CODE!][!WS "0"!]
        ...
        [!ELSEIF "contains($DerivativeName, 'S32K328') or contains($DerivativeName, 'S32K338') or contains($DerivativeName, 'S32K348')"!][!//
            [!CODE!][!WS "0"!]#include "S32K358_EDMA.h"[!CR!][!ENDCODE!][!//
            [!CODE!][!WS "0"!]
    ...
    [!ELSEIF "contains($DerivativeName, 'S32M276') or contains($DerivativeName, 'S32M274')"!][!//
        [!CODE!][!WS "0"!]#include "S32M27x_EDMA.h"[!CR!][!ENDCODE!][!//
        [!CODE!][!WS "0"!]#include "S32M27x_DMA_TCD.h"[!CR!][!ENDCODE!][!//
    [!ELSE!][!//
        [!ERROR "The Resource plugin or ResourceSubderivative field is not available for header file inclusion."!][!//
    [!ENDIF!][!//
    [!IF "contains($DerivativeName, 'S32K396') or contains($DerivativeName, 'S32K394')"!][!//
        [!CODE!]
        #define DMA_TCD_INSTANCE_COUNT        eDMA_INSTANCE_COUNT
        [!ENDCODE!][!//
    [!ENDIF!][!//
[!ENDIF!][!//
[!ENDINDENT!][!//
...
[!IF "contains($DerivativeName, 'S32K396') or contains($DerivativeName, 'S32K394')"!][!//
    [!CODE!][!WS "0"!]
    #define DMA_IP_DMA_0_BASE                   (0x4020C000U)
    #define DMA_IP_DMA_0_BASE_PTR               ((Dma_Ip_Hwv3InstRegType *)DMA_IP_DMA_0_BASE)
    #define DMA_IP_DMA_1_BASE                   (0x40010000U)
    #define DMA_IP_DMA_1_BASE_PTR               ((Dma_Ip_Hwv3InstRegType *)DMA_IP_DMA_1_BASE)
    #define DMA_IP_DMA_BASE_PTRS               {DMA_IP_DMA_0_BASE_PTR, DMA_IP_DMA_1_BASE_PTR}
    [!CR!][!ENDCODE!][!//
[!ELSE!][!//
    [!CODE!][!WS "0"!]
...
[!IF "contains($DerivativeName, 'S32K396') or contains($DerivativeName, 'S32K394')"!][!//
    [!CODE!][!WS "0"!]
    #define DMA_IP_DMA_NOF_HWV3_INST            ((uint32)2U)  /* Total number of hardware instances */
    [!CR!][!ENDCODE!][!//
[!ELSE!][!//
    [!CODE!][!WS "0"!]
...
[!IF "contains($DerivativeName, 'S32K396') or contains($DerivativeName, 'S32K394')"!][!//
    [!CODE!][!WS "0"!]
    #define DMA_IP_TCD_0_BASE                   (0x40210000U)
    #define DMA_IP_TCD_0_BASE_PTR               ((Dma_Ip_Hwv3TcdArrayType *)DMA_IP_TCD_0_BASE)
    #define DMA_IP_TCD_1_BASE                   (0x40014000U)
    #define DMA_IP_TCD_1_BASE_PTR               ((Dma_Ip_Hwv3TcdArrayType *)DMA_IP_TCD_1_BASE)
    #define DMA_IP_TCD_BASE_PTRS               {DMA_IP_TCD_0_BASE_PTR, DMA_IP_TCD_1_BASE_PTR}
    [!CR!][!ENDCODE!][!//
[!ELSE!][!//
    [!CODE!][!WS "0"!]
...
[!IF "contains($DerivativeName, 'S32K396') or contains($DerivativeName, 'S32K394')"!][!//
    [!CODE!][!WS "0"!]
    #define DMA_IP_TCD_0_PTR                    {((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(0U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(1U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(3U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(4U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(5U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(6U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(7U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(8U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(9U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(10U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(11U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2097152U + (0U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2097152U + (1U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2097152U + (2U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2097152U + (3U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2097152U + (4U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2097152U + (5U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2097152U + (6U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2097152U + (7U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2097152U + (8U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2097152U + (9U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2097152U + (10U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2097152U + (11U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2097152U + (12U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2097152U + (13U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2097152U + (14U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2097152U + (15U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2097152U + (16U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2097152U + (17U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2097152U + (18U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_0_BASE + (uint32)(2097152U + (19U * 16384U))))}

    #define DMA_IP_TCD_1_PTR                    {((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(0U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(1U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(2U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(3U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(4U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(5U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(6U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(7U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(8U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(9U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(10U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(11U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(12U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(13U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(14U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(15U * 16384U))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(6209536U + (0U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(6209536U + (1U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(6209536U + (2U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(6209536U + (3U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(6209536U + (4U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(6209536U + (5U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(6209536U + (6U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(6209536U + (7U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(6209536U + (8U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(6209536U + (9U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(6209536U + (10U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(6209536U + (11U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(6209536U + (12U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(6209536U + (13U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(6209536U + (14U * 16384U)))),\
                                                 ((Dma_Ip_Hwv3ChTcdRegType *)((uint32)DMA_IP_TCD_1_BASE + (uint32)(6209536U + (15U * 16384U))))}

    #define DMA_IP_TCD_PTR_ARRAY                {DMA_IP_TCD_0_PTR, DMA_IP_TCD_1_PTR}
    [!CR!][!ENDCODE!][!//
[!ELSE!][!//
    [!CODE!][!WS "0"!]
...
[!IF "contains($DerivativeName, 'S32K396') or contains($DerivativeName, 'S32K394')"!][!//
    [!CODE!][!WS "0"!]
    #define DMA_IP_BASE_ADDR(instIdx) \
            ((uint32)(((instIdx)>0UL) ? \
            (DMA_IP_DMA_1_BASE) : (DMA_IP_DMA_0_BASE)))
    [!CR!][!ENDCODE!][!//
[!ELSE!][!//
    [!CODE!][!WS "0"!]
...
/-----------------------------------------------*/
[!CODE!]
[!VAR "NumberDmaHwInstance" = "num:i(count(ecu:list('Mcl.MclConfigSet.DmaHwInstance.List')))"!]
#define DMA_IP_DMA_TOTAL_NOF_INST             ((uint32)[!"num:i($NumberDmaHwInstance)"!]U)
[!ENDCODE!]

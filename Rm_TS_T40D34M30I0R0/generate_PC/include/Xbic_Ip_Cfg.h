...
[!LOOP "variant:all()"!]
[!CODE!]#include "Xbic_Ip_[!"."!]_PBcfg.h"[!CR!][!ENDCODE!]
[!ENDLOOP!]
[!ELSE!]
[!CODE!]#include "Xbic_Ip_PBcfg.h"[!ENDCODE!]
[!ENDIF!]
[!ENDNOCODE!]
...
[!LOOP "variant:all()"!]
[!CODE!][!//
/* Checks against Xbic_Ip_[!"."!]_PBcfg.h */
#if (RM_XBIC_IP_CFG_VENDOR_ID != RM_XBIC_IP_[!"."!]_PBCFG_VENDOR_ID)
    #error "Xbic_Ip_Cfg.h and Xbic_Ip_[!"."!]_PBcfg.h have different vendor ids"
#endif
#if ((RM_XBIC_IP_CFG_AR_RELEASE_MAJOR_VERSION    != RM_XBIC_IP_[!"."!]_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (RM_XBIC_IP_CFG_AR_RELEASE_MINOR_VERSION    != RM_XBIC_IP_[!"."!]_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (RM_XBIC_IP_CFG_AR_RELEASE_REVISION_VERSION != RM_XBIC_IP_[!"."!]_PBCFG_AR_RELEASE_REVISION_VERSION))
     #error "AUTOSAR Version Numbers of Xbic_Ip_Cfg.h and Xbic_Ip_[!"."!]_PBcfg.h are different"
#endif
#if ((RM_XBIC_IP_CFG_SW_MAJOR_VERSION != RM_XBIC_IP_[!"."!]_PBCFG_SW_MAJOR_VERSION) || \
     (RM_XBIC_IP_CFG_SW_MINOR_VERSION != RM_XBIC_IP_[!"."!]_PBCFG_SW_MINOR_VERSION) || \
     (RM_XBIC_IP_CFG_SW_PATCH_VERSION != RM_XBIC_IP_[!"."!]_PBCFG_SW_PATCH_VERSION))
    #error "Software Version Numbers of Xbic_Ip_Cfg.h and Xbic_Ip_[!"."!]_PBcfg.h are different"
#endif
[!ENDCODE!]
[!ENDLOOP!]
[!ELSE!]
...
#define XBIC_CONFIG_EXT \[!CR!][!ENDCODE!]
[!IF "var:defined('postBuildVariant')"!]
    [!VAR "variantIndex"="0"!][!//
    [!VAR "variantNumber"="variant:size()"!][!//
[!LOOP "variant:all()"!][!//
    [!VAR "variantIndex"="$variantIndex + 1"!][!//
    [!CODE!][!WS "4"!]XBIC_CONFIG_[!"."!]_PB[!IF "$variantIndex < $variantNumber"!] \[!CR!][!ENDIF!][!ENDCODE!]
[!ENDLOOP!][!//
[!ELSE!][!//
    [!CODE!][!WS "4"!]XBIC_CONFIG_PB[!ENDCODE!]
[!ENDIF!]
[!ENDIF!]
[!ENDNOCODE!]

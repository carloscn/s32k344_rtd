...
[!LOOP "variant:all()"!]
[!CODE!]#include "Mscm_Ip_[!"."!]_PBcfg.h"[!CR!][!ENDCODE!]
[!ENDLOOP!]
[!ELSE!]
[!CODE!]#include "Mscm_Ip_PBcfg.h"[!ENDCODE!]
[!ENDIF!]
[!ENDNOCODE!]
...
[!LOOP "variant:all()"!]
[!CODE!][!//
/* Checks against Mscm_Ip_[!"."!]_PBcfg.h */
#if (RM_MSCM_IP_CFG_VENDOR_ID != RM_MSCM_IP_PBCFG_[!"."!]_VENDOR_ID)
    #error "Mscm_Ip_Cfg.h and Mscm_Ip_[!"."!]_PBcfg.h have different vendor ids"
#endif
#if ((RM_MSCM_IP_CFG_AR_RELEASE_MAJOR_VERSION    != RM_MSCM_IP_PBCFG_[!"."!]_AR_RELEASE_MAJOR_VERSION) || \
     (RM_MSCM_IP_CFG_AR_RELEASE_MINOR_VERSION    != RM_MSCM_IP_PBCFG_[!"."!]_AR_RELEASE_MINOR_VERSION) || \
     (RM_MSCM_IP_CFG_AR_RELEASE_REVISION_VERSION != RM_MSCM_IP_PBCFG_[!"."!]_AR_RELEASE_REVISION_VERSION))
     #error "AUTOSAR Version Numbers of Mscm_Ip_Cfg.h and Mscm_Ip_[!"."!]_PBcfg.h are different"
#endif
#if ((RM_MSCM_IP_CFG_SW_MAJOR_VERSION != RM_MSCM_IP_PBCFG_[!"."!]_SW_MAJOR_VERSION) || \
     (RM_MSCM_IP_CFG_SW_MINOR_VERSION != RM_MSCM_IP_PBCFG_[!"."!]_SW_MINOR_VERSION) || \
     (RM_MSCM_IP_CFG_SW_PATCH_VERSION != RM_MSCM_IP_PBCFG_[!"."!]_SW_PATCH_VERSION))
    #error "Software Version Numbers of Mscm_Ip_Cfg.h and Mscm_Ip_[!"."!]_PBcfg.h are different"
#endif
[!ENDCODE!]
[!ENDLOOP!]
[!ELSE!]
...
*/
#define MSCM_CONFIG_EXT \[!CR!][!ENDCODE!]
[!IF "var:defined('postBuildVariant')"!]
    [!VAR "variantIndex"="0"!][!//
    [!VAR "variantNumber"="variant:size()"!][!//
[!LOOP "variant:all()"!][!//
    [!VAR "variantIndex"="$variantIndex + 1"!][!//
    [!CODE!][!WS "4"!]MSCM_CONFIG_[!"."!]_PB[!IF "$variantIndex < $variantNumber"!] \[!CR!][!ENDIF!][!ENDCODE!]
[!ENDLOOP!][!//
[!ELSE!][!//
    [!CODE!][!WS "4"!]MSCM_CONFIG_PB[!ENDCODE!]
[!ENDIF!]
[!ENDNOCODE!]

#define RM_IP_ENABLE_MSCM                               ([!IF "RmGeneral/RmEnableMscmSupport"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
[!ENDIF!]
/*==================================================================================================
*                                             ENUMS
==================================================================================================*/

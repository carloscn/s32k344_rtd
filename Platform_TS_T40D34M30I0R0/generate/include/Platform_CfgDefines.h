...
/*********************************** MPU_M7 SECTION *******************************/
#define PLATFORM_ENABLE_MPU_M7                              ([!IF "GeneralConfiguration/PlatformMpuM7Configurable"!]STD_ON[!ELSE!]STD_OFF[!ENDIF!])
...
/* Support for MRU */
[!NOCODE!]
[!VAR "MruSupport"="'STD_OFF'"!]
[!IF "node:exists(GeneralConfiguration/PlatformEnableMruConfiguration)"!]
    [!IF "GeneralConfiguration/PlatformEnableMruConfiguration"!]
        [!VAR "MruSupport"="'STD_ON'"!]
    [!ENDIF!]
[!ENDIF!]
[!ENDNOCODE!]

...
[!LOOP "variant:all()"!]
[!CODE!]
/* Check if Adc_Ipw_Cfg.h file and Adc_Ipw_[!"."!]_PBcfg.h file are of the same vendor */
#if (ADC_IPW_VENDOR_ID_CFG != ADC_IPW_VENDOR_ID_[!"text:toupper(.)"!]_PBCFG)
    #error "Adc_Ipw_Cfg.h and Adc_Ipw_[!"."!]_PBcfg.h have different vendor ids"
#endif

/* Check if Adc_Ipw_Cfg.h file and Adc_Ipw_[!"."!]_PBcfg.h file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Adc_Ipw_Cfg.h and Adc_Ipw_[!"."!]_PBcfg.h are different"
#endif

/* Check if Adc_Ipw_Cfg.h file and Adc_Ipw_[!"."!]_PBcfg.h file are of the same Software version */
  ...
  #error "Software Version Numbers of Adc_Ipw_Cfg.h and Adc_Ipw_[!"."!]_PBcfg.h are different"
#endif
[!ENDCODE!]
[!ENDLOOP!]
[!ELSE!]

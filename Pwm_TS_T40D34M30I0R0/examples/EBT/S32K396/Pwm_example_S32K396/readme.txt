1. Example Description
    ...
    The application includes an EB Tresos project that configures the Base, Dem, Mcl, EcuC, Pwm, Mcu, Platform, Port, Dio and Resource drivers.
...
2. Installation steps
    2.1 Hardware installation
        ...
        2.1.3 Debugger
            - The Lauterbach debugger must be connected to J20 JTAG Cortex Debug connector.

...
typedef uint16_t hseAttrId_t;
    ...
    #define HSE_APP_SPECIFIC_DATA_ATTR_ID           ((hseAttrId_t)27U)    /**< @brief NVM-RW-ATTR; Set an application-specific data of maximum 256 bytes. */
    #endif /* HSE_SPT_APP_SPECIFIC_DATA_CONFIG */
...
==================================================================================================*/
#define HSE_APP_SPECIFIC_DATA_MAX_BUFFER_SIZE      (256U)   /**< @brief Maximum buffer size of application
                                                                 specific data stored in the persistent memory. */

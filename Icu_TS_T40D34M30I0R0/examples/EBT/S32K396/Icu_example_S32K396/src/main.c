...
*                                       GLOBAL FUNCTIONS
==================================================================================================*/
extern ISR(EMIOS0_2_IRQ);
extern ISR(SIUL2_EXT_IRQ_24_31_ISR);
...
void User_EdgeDetect0(void)
{
    ...
    {
        Dio_WriteChannel(DioConf_DioChannel_Digital_Output_LED_D35, STD_HIGH);
    }
    else
    {
        Dio_WriteChannel(DioConf_DioChannel_Digital_Output_LED_D35, STD_LOW);
    }
}
...
void User_EdgeDetect1(void)
{
    ...
    {
        Dio_WriteChannel(DioConf_DioChannel_Digital_Output_LED_D34, STD_HIGH);
    }
    else
    {
        Dio_WriteChannel(DioConf_DioChannel_Digital_Output_LED_D34, STD_LOW);
    }
}
...
void User_EdgeDetect2(void)
{
    ...
    {
        Dio_WriteChannel(DioConf_DioChannel_Digital_Output_LED_D33, STD_HIGH);
    }
    else
    {
        Dio_WriteChannel(DioConf_DioChannel_Digital_Output_LED_D33, STD_LOW);
    }
}
/**
...
int main(void) 
{
    ...
    /* Install Emios ISR */
    Platform_InstallIrqHandler(EMIOS0_2_IRQn, &EMIOS0_2_IRQ, NULL_PTR);
    Platform_SetIrq(EMIOS0_2_IRQn,TRUE);

...
void User_EdgeDetect0(void)
{
    ...
    {
        Siul2_Dio_Ip_WritePin(Digital_Output_LED_D35_PORT, Digital_Output_LED_D35_PIN, 1);
    }
    else
    {
        Siul2_Dio_Ip_WritePin(Digital_Output_LED_D35_PORT, Digital_Output_LED_D35_PIN, 0);
    }
}
/**
...
{   
    ...
    /* Install Emios ISR */
    IntCtrl_Ip_InstallHandler(EMIOS0_2_IRQn, &EMIOS0_2_IRQ, NULL_PTR);
    IntCtrl_Ip_EnableIrq(EMIOS0_2_IRQn);
    ...
    Emios_Icu_Ip_EnableEdgeDetection(0,14);
    Emios_Icu_Ip_EnableNotification(0,14);

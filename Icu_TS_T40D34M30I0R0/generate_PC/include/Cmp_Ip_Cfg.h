...
#if (CMP_IP_CFG_VENDOR_ID != CMP_IP_[!"."!]_PBCFG_VENDOR_ID)
...
#if ((CMP_IP_CFG_AR_RELEASE_MAJOR_VERSION    != CMP_IP_[!"."!]_PBCFG_AR_RELEASE_MAJOR_VERSION) || \
     (CMP_IP_CFG_AR_RELEASE_MINOR_VERSION    != CMP_IP_[!"."!]_PBCFG_AR_RELEASE_MINOR_VERSION) || \
     (CMP_IP_CFG_AR_RELEASE_REVISION_VERSION != CMP_IP_[!"."!]_PBCFG_AR_RELEASE_REVISION_VERSION))
...
#if ((CMP_IP_CFG_SW_MAJOR_VERSION != CMP_IP_[!"."!]_PBCFG_SW_MAJOR_VERSION) || \
     (CMP_IP_CFG_SW_MINOR_VERSION != CMP_IP_[!"."!]_PBCFG_SW_MINOR_VERSION) || \
     (CMP_IP_CFG_SW_PATCH_VERSION != CMP_IP_[!"."!]_PBCFG_SW_PATCH_VERSION))
...
[!IF "var:defined('postBuildVariant')"!][!//
    [!LOOP "variant:all()"!][!//
        [!CODE!][!WS "8"!]CMP_CONFIG_[!"."!]_PB \[!CR!][!ENDCODE!]
    [!ENDLOOP!][!//
[!ELSE!][!//

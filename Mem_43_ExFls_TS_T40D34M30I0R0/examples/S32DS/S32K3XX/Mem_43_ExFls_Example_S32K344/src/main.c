...
#define WRITE_ADDR                  0x0U
#define SECTOR_SIZE                 0x1000U
#define WRITE_SIZE                  256U
...
{
#if (defined(S32K344) || defined(S32K342) || defined(S32K314) || defined(S32K324) || defined(S32K341) || defined(S32K322))
    /* QuadSPI_PCSFA - PTC3 */
    ...
    /* QuadSPI_IOFA4 - PTC0 */
    IP_SIUL2->MSCR[64] = SIUL2_MSCR_OBE(1U) | SIUL2_MSCR_IBE(1U) | SIUL2_MSCR_SSS(4U) | SIUL2_MSCR_DSE(1U);
    IP_SIUL2->IMCR[931 - 512] = SIUL2_IMCR_SSS(1U);

    /* QuadSPI_IOFA5 - PTD9 */
    IP_SIUL2->MSCR[105] = SIUL2_MSCR_OBE(1U) | SIUL2_MSCR_IBE(1U) | SIUL2_MSCR_SSS(8U) | SIUL2_MSCR_DSE(1U);
    IP_SIUL2->IMCR[932 - 512] = SIUL2_IMCR_SSS(1U);

    /* QuadSPI_IOFA6 - PTD8 */
    IP_SIUL2->MSCR[104] = SIUL2_MSCR_OBE(1U) | SIUL2_MSCR_IBE(1U) | SIUL2_MSCR_SSS(8U) | SIUL2_MSCR_DSE(1U);
    IP_SIUL2->IMCR[933 - 512] = SIUL2_IMCR_SSS(1U);

    /* QuadSPI_IOFA7 - PTC17 */
    IP_SIUL2->MSCR[81] = SIUL2_MSCR_OBE(1U) | SIUL2_MSCR_IBE(1U) | SIUL2_MSCR_SSS(8U) | SIUL2_MSCR_DSE(1U);
    IP_SIUL2->IMCR[934 - 512] = SIUL2_IMCR_SSS(1U);
#endif
    /*Implement Pin for QSPI*/
}

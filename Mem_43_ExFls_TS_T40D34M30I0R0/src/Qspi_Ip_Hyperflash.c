...
static Qspi_Ip_StatusType Qspi_Ip_HyperflashWaitDeviceReady(uint32 instance)
{
    ...
    u32TimeoutTicks = OsIf_MicrosToTicks(QSPI_IP_FLS_INIT_TIMEOUT, QSPI_IP_TIMEOUT_TYPE);
    ...
    while (((u32ElapsedTicks < u32TimeoutTicks) && ((readValue & QSPI_IP_HF_SR_DRB_MASK) == 0U)));
